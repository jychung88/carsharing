...
<v-card style="width:300px; margin-left:5%;" outlined>
    ...
    <v-card-text style = "margin-left:-15px; margin-top:10px;">
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="CarId" v-model="value.carId"/>
          </div>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="LentalAddr" v-model="value.lentalAddr"/>
          </div>
          <div class="grey--text ml-4" v-else>
            LentalAddr :  {{value.lentalAddr }}
          </div>

          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="RetriveAddr" v-model="value.retriveAddr"/>
          </div>
          <div class="grey--text ml-4" v-else>
            RetriveAddr :  {{value.retriveAddr }}
          </div>
