...
1. 장애격리
    ...
    1. 결재시스템이 과중되면 사용자를 잠시동안 받지 않고 예약를 잠시후에 하도록 유도한다 Circuit breaker, fallback
1. 성능
...
![image](https://user-images.githubusercontent.com/84000909/122487297-e3393580-d015-11eb-9660-dc93da9c79c3.png)
